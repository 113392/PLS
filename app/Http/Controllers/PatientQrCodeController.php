...
class PatientQrCodeController extends Controller
{
    ...
    function generateRandomQR($length = 64)
    {
        ...
        // Generiere eine zufällige Zeichenkette der angegebenen Länge
    ...
    public function generateQRCodeForPatients(Request $request)
    {
        ...
        for ($i = 0; $i < $number; $i++) {
            ...
            // Sicherstellen, dass der QR-Code eindeutig ist, indem geprüft wird, ob er bereits existiert
            ...
            // QR-Code zur Rückgabemenge hinzufügen
