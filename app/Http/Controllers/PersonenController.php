...
class PersonenController extends Controller
{
    ...
    *
     ...
     *
     * @param int $id ID der Person.
     * @return \Illuminate\Http\JsonResponse Gibt die Informationen der Person im JSON-Format zurück.
     */
     ...
     *
     * @return \Illuminate\Http\JsonResponse Gibt den ersten Eintrag der Tabelle oder eine Fehlermeldung zurück.
     */
